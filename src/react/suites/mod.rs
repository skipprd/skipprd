...
use crate::adapters::storage::{S3StorageAdapter, StorageAdapter};
use std::sync::Arc;
...
impl Default for SuiteCtx {
    fn default() -> Self {
        Self {
            storage: Arc::new(S3StorageAdapter::default()),
            ...
            keyspace: Arc::new(crate::react::providers::DefaultKeyspace::new("unset".to_string())),
