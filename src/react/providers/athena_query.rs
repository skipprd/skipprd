...
use crate::react::providers::{DatasetCatalogProvider, DatasetId, QueryProvider, QueryResult};
...
impl DatasetCatalogProvider for AthenaQueryProvider {
    ...
    async fn get_dataset_stats(
        ...
        let mut ns_stats = crate::discover::stats::NamespaceStats::new(&dataset.fqn());
        ...
        let mut ds = crate::react::providers::catalog::types::DatasetStats::default();
