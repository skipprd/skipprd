...
pub const CURATED_STREAMS: &[MetaStreamDef] = &[
    MetaStreamDef {
        namespace: "meta_instagram_ads.account_daily",
        level: InsightsLevel::Account,
        placement_breakdown: false,
    },
    MetaStreamDef {
        namespace: "meta_instagram_ads.campaign_daily",
        level: InsightsLevel::Campaign,
        placement_breakdown: false,
    },
    MetaStreamDef {
        namespace: "meta_instagram_ads.adset_daily",
        level: InsightsLevel::Adset,
        placement_breakdown: false,
    },
    MetaStreamDef {
        namespace: "meta_instagram_ads.ad_daily",
        level: InsightsLevel::Ad,
        placement_breakdown: false,
    },
    MetaStreamDef {
        namespace: "meta_instagram_ads.campaign_placement_daily",
        level: InsightsLevel::Campaign,
        placement_breakdown: true,
    },
];

const MINIMAL_NAMESPACES: &[&str] = &["meta_instagram_ads.account_daily"];

const STANDARD_NAMESPACES: &[&str] = &[
    "meta_instagram_ads.account_daily",
    "meta_instagram_ads.campaign_daily",
    "meta_instagram_ads.adset_daily",
];
...
mod tests {
    ...
    fn minimal_profile_is_account_only() {
        ...
        assert_eq!(streams[0].namespace, "meta_instagram_ads.account_daily");
    }
    ...
    fn placement_stream_uses_campaign_level_with_breakdown() {
        let placement = CURATED_STREAMS
            .iter()
            .find(|s| s.namespace == "meta_instagram_ads.campaign_placement_daily")
            .unwrap();
