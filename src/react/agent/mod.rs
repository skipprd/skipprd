...
use crate::react::tools::ToolRegistry;
use crate::llm::ChatMessage;
use crate::react::session::{ThreadStore, ThreadStep, ThreadResult, ThreadLog};
use crate::react::providers::{Keyspace, RequestScope};
use crate::react::providers::DbtProvider;
...
pub struct AgentCtx {
    ...
    /// Authoritative request scope (tenant/workspace/pipeline). Today comes from Config bootstrap;
