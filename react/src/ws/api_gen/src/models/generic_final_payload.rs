...
pub struct GenericFinalPayload {
    /// Human-readable final text for non-Ask suites during migration.
    #[serde(rename = "text")]
    pub text: String,
}

impl GenericFinalPayload {
    pub fn new(text: String) -> GenericFinalPayload {
        GenericFinalPayload { text }
    }
}
