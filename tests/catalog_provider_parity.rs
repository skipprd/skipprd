...
use skippr::adapters::storage::{InMemoryStorageAdapter, StorageAdapter};
...
use skippr::react::providers::catalog::types::{SemanticModel, DataCatalog};
...
async fn provider_write_semantic_uses_keyspace_key_and_roundtrips() {
    ...
    let llm: Arc<dyn skippr::llm::LargeLanguageModel> = Arc::new(skippr::llm::NullModel::new());
