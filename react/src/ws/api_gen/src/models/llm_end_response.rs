...
impl LlmEndResponse {
    pub fn new(v: i32, r#type: Type, server_time: String, seq: i32, thread_id: String, call_id: i32, phase: String, status: Status) -> LlmEndResponse {
        LlmEndResponse {
            v,
            r#type,
            server_time,
