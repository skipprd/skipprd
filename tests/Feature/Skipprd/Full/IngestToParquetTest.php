...
class IngestToParquetTest extends TestCase
{
    ...
    public function fullRun()
    {
        ...
        $this->readFile($src, function ($string) use ($serde, $container, &$fields) {
            ...
            foreach ($msgs as $msg) {
                ...
                $container->analysePayload($msg, Config::$discoveredFieldOccurrence);
//              $fields[] = $serde->deserialize($string);
                }
