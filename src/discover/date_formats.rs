...
impl DateFormats {
    ...
    pub fn name(&self) -> &'static str {
        match self {
            ...
            DateFormats::Iso8601SpaceZ => "Iso8601_SpaceZ",
            DateFormats::Iso8601SpaceOffset => "Iso8601_SpaceOffset",
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            DateFormats::Iso8601SpaceZ => "%Y-%m-%d %H:%M:%SZ",
            DateFormats::Iso8601SpaceOffset => "%Y-%m-%d %H:%M:%S%z",
    ...
    pub fn from_str(input: &str) -> Result<DateFormats, bool> {
        match input {
            ...
            "Iso8601_SpaceZ" => Ok(DateFormats::Iso8601SpaceZ),
            "Iso8601_SpaceOffset" => Ok(DateFormats::Iso8601SpaceOffset),
