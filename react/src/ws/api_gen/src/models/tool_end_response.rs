...
impl ToolEndResponse {
    pub fn new(v: i32, r#type: Type, server_time: String, seq: i32, thread_id: String, tool_id: String, name: String, status: models::ToolEventStatus) -> ToolEndResponse {
        ToolEndResponse {
            v,
            r#type,
            server_time,
