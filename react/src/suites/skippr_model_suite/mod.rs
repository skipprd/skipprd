...
impl SkipprModelSuite {
    ...
    fn build_tools(agent_type: &str, sctx: &SuiteCtx) -> Result<ToolRegistry, String> {
        ...
        match agent_type {
            ...
            _ => {
                ...
                use crate::suites::skippr_ask_suite::tools::{ask_approval::AskApprovalTool, ask_user::AskUserTool};
                use crate::suites::skippr_model_suite::tools::{
    ...
    pub(crate) async fn run_cleanse(thread_id: &str, question: &str, sctx: &SuiteCtx) -> Result<Vec<FlowFrame>, String> {
        let sys = crate::util::time_context::with_time_context(crate::prompts::ask_legacy::system_prompt());
        let tools_card = crate::prompts::ask_legacy::tool_card();
    ...
    pub(crate) async fn run_model(thread_id: &str, question: &str, sctx: &SuiteCtx) -> Result<Vec<FlowFrame>, String> {
        let sys = crate::util::time_context::with_time_context(crate::suites::skippr_model_suite::prompts::system_prompt());
        let tools_card = crate::suites::skippr_model_suite::prompts::tool_card();
