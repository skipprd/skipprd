...
pub enum PlanChecklistOrigin {
    #[serde(rename = "initial")]
    Initial,
    #[serde(rename = "review_actionable")]
    ReviewActionable,

}

impl std::fmt::Display for PlanChecklistOrigin {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Initial => write!(f, "initial"),
            Self::ReviewActionable => write!(f, "review_actionable"),
        }
    }
}

impl Default for PlanChecklistOrigin {
    fn default() -> PlanChecklistOrigin {
        Self::Initial
    }
}
