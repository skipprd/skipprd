...
use legacy\src\Skipprd\Arr;
use legacy\src\Skipprd\Buffers\BufferAdaptorsFactory;
use legacy\src\Skipprd\Helpers;
use legacy\src\Skipprd\InternalFields;
use legacy\src\Skipprd\MachineToHuman\BytesToHuman;
use legacy\src\Skipprd\MachineToHuman\NumberToHuman;
use legacy\src\Skipprd\Metrics;
use legacy\src\Skipprd\Plugins\DataOutputs\DataOutputPluginInterface;
use legacy\src\Skipprd\Plugins\DataSources\DataSourcePluginInterface;
use legacy\src\Skipprd\Plugins\OffsetDrivers\OffsetDriverFactory;
use legacy\src\Skipprd\Plugins\PluginFactory;
use legacy\src\Skipprd\Serders\SerdersFactory;
use legacy\src\Skipprd\SkipprLogger;
use legacy\src\Skipprd\SkipprPack;
use legacy\src\Skipprd\StatTimer;
...
use legacy\src\Skipprd\Traits\IngestFast;
use legacy\src\Skipprd\Traits\LicenseChecker;
use legacy\src\Skipprd\Traits\RecordFilter;
use legacy\src\Skipprd\Traits\SkipprStream;
use legacy\src\Skipprd\Traits\TaskResponse;
use function Skipprd\Commands\array_key_first;
use function Skipprd\Commands\count;
...
//SerializesModels;
    ...
    /**
     * @var \legacy\src\Skipprd\Serders\Interfaces\SerderBatchInterface|\legacy\src\Skipprd\Serders\Interfaces\SerderStreamInterface
     */
    public $inputSerder;
...
//    public $deadLetters = 0;
    ...
    /**
     * @var \legacy\src\Skipprd\Plugins\DataSources\DataSourcePluginBase
     */
    public $inputPlugin = null;

    /**
     * @var \legacy\src\Skipprd\Plugins\DataOutputs\DataOutputPluginBase
     */
    ...
    /**
     * @var \legacy\src\Skipprd\Buffers\BufferInterface|null
     */
...
//        }
            ...
            if (!empty($this->inputPlugin)) {
                ...
                if (Config::$runMode == Config::RUN_MODE_VALIDATE_SCHEMA) {
                    $command = new \legacy\src\Skipprd\Commands\ValidateSchemaFile();
                    $command->handle();
                    $this->shutdown();
                }
...
//            }
            ...
            \legacy\src\Skipprd\StatTimer::parse();
