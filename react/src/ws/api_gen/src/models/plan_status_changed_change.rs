...
pub struct PlanStatusChangedChange {
    #[serde(rename = "from")]
    pub from: models::PlanStatus,
    #[serde(rename = "to")]
    pub to: models::PlanStatus,
}

impl PlanStatusChangedChange {
    pub fn new(from: models::PlanStatus, to: models::PlanStatus) -> PlanStatusChangedChange {
