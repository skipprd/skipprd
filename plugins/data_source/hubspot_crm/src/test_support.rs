...
use crate::hubspot::DataSourceHubspotCrmPluginConfig;
use crate::hubspot_api::FIXTURE_ENV;
use crate::privacy::{PrivacyConfig, PrivacyMode, PrivacyProfile};
use crate::streams::StreamProfile;

pub fn sample_config() -> DataSourceHubspotCrmPluginConfig {
    DataSourceHubspotCrmPluginConfig {
        hub_id: "12345678".into(),
