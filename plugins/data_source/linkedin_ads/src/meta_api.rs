...
fn load_fixture_insights(dir: &str, namespace: &str) -> Option<serde_json::Value> {
    let file = match namespace {
        "linkedin_ads.account_daily" => "account_insights.json",
        "linkedin_ads.campaign_daily" => "campaign_insights.json",
        "linkedin_ads.adset_daily" => "adset_insights.json",
        "linkedin_ads.ad_daily" => "ad_insights.json",
        "linkedin_ads.campaign_placement_daily" => "campaign_placement_insights.json",
        _ => return None,
    };
