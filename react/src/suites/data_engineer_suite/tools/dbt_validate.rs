...
impl Tool for DbtValidateTool {
    ...
    async fn call(&self, args: Value, ctx: &AgentCtx) -> Result<Value, String> {
        ...
        let dialect = ctx
            .resolved_config
            .as_ref()
            .map(|c| crate::dbt::remediate::active_provider_dialect(c.as_ref()))
...
mod tests {
    ...
    use crate::providers::{DbtProvider, Keyspace, RequestScope};
    use async_trait::async_trait;
    ...
    async fn dbt_validate_retries_once_after_remediation_on_sql_failure() {
        ...
        let llm: Arc<dyn crate::llm::LargeLanguageModel> = Arc::new(MockLlm {
