//! Shared helpers for integration tests (fixture env, mock sync context).
...
use crate::config::{DataSourceGoogleSerpRanksPluginConfig, SerpDevice, TargetEntry};
use crate::worker::FIXTURE_ENV;

pub fn sample_config() -> DataSourceGoogleSerpRanksPluginConfig {
