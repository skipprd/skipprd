...
use crate::xero_accounting::DataSourceXeroAccountingPluginConfig;
use crate::xero_api::FIXTURE_ENV;

pub fn sample_config() -> DataSourceXeroAccountingPluginConfig {
    DataSourceXeroAccountingPluginConfig {
        tenant_id: "a1b2c3d4-e5f6-7890-abcd-ef1234567891".into(),
        ...
        oauth_token_url: "https://identity.xero.com/connect/token".into(),
