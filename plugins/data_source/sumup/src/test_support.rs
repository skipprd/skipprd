...
use crate::sumup::DataSourceSumUpPluginConfig;
use crate::sumup_api::FIXTURE_ENV;

pub fn sample_config() -> DataSourceSumUpPluginConfig {
    DataSourceSumUpPluginConfig {
        merchant_code: "MH4H92C7".into(),
        start_date: "2024-01-01".into(),
        lookback_days: 30,
        stream_profile: StreamProfile::ConsoleDefault,
        streams: None,
        min_query_interval_ms: 0,
        oauth_token_url: "https://api.sumup.com/token".into(),
