...
//    use InteractsWithConsole;
    ...
    public function setUp() {
        ...
        $this->schemaV2 = factory(Schema::class)->states('new_schema_version')->create([
            'ingest_job_id' => $this->ingest_job_id,
        ]);
    ...
    public function testSubjects()
    {
        ...
        $response->assertJsonFragment(['ingest_job_id' => "$this->ingest_job_id"]);
    }
    ...
    public function testschemasGetId()
    {
        ...
        $response->assertStatus(200);
        $response->assertSeeText($this->schema->name);
    }

    public function testschemasGetId2()
    {

        $headers = ['Authorization' => "Bearer " . $this->userAuth->api_token];

        $response = $this->get('/schemas/ids/2', $headers);

        $response->assertStatus(200);
        $response->assertSeeText($this->schemaV2->name);
    }
