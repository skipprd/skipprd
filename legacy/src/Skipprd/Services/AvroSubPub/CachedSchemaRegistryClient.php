<?php
namespace legacy\src\Skipprd\Services\AvroSubPub;
...
class CachedSchemaRegistryClient
{
     ...
     */
    public function __construct(array $url, int $maxSchemasPerSubject = 1000)
    {
    ...
    public function sendRequest($url, $method = 'GET', $body = null, $headers = null)
    {
...
//                $request = $this->client->delete($url, $headers);
     ...
     */
    public function cacheSchema(AvroSchema $schema, $schemaId, $subject = null, $version = null)
    {
        if (isset($this->idToSchema[$schemaId])) {
