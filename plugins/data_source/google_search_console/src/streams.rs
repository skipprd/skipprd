...
pub const CURATED_STREAMS: &[GscStreamDef] = &[
    GscStreamDef {
        namespace: "google_search_console.site_daily",
        dimensions: &["date"],
        kind: GscStreamKind::SearchAnalytics,
        optional: false,
    },
    GscStreamDef {
        namespace: "google_search_console.query_daily",
        dimensions: &["date", "query"],
        kind: GscStreamKind::SearchAnalytics,
        optional: false,
    },
    GscStreamDef {
        namespace: "google_search_console.page_daily",
        dimensions: &["date", "page"],
        kind: GscStreamKind::SearchAnalytics,
        optional: false,
    },
    GscStreamDef {
        namespace: "google_search_console.device_daily",
        dimensions: &["date", "device"],
        kind: GscStreamKind::SearchAnalytics,
        optional: false,
    },
    GscStreamDef {
        namespace: "google_search_console.country_daily",
        dimensions: &["date", "country"],
        kind: GscStreamKind::SearchAnalytics,
        optional: false,
    },
    GscStreamDef {
        namespace: "google_search_console.page_query_daily",
        dimensions: &["date", "page", "query"],
        kind: GscStreamKind::SearchAnalytics,
        optional: false,
    },
    GscStreamDef {
        namespace: "google_search_console.search_appearance_daily",
        dimensions: &["date", "searchAppearance"],
        kind: GscStreamKind::SearchAnalytics,
        optional: true,
    },
    GscStreamDef {
        namespace: "google_search_console.sitemap_daily",
        dimensions: &["date", "path"],
        kind: GscStreamKind::SitemapSnapshot,
        optional: false,
    },
    GscStreamDef {
        namespace: "google_search_console.site_run_daily",
        dimensions: &["date"],
...
pub const URL_INSPECTION_NAMESPACE: &str = "google_search_console.url_inspection_daily";

const MINIMAL_NAMESPACES: &[&str] = &["google_search_console.site_daily"];

const STANDARD_EXCLUDED: &[&str] = &[
    "google_search_console.page_query_daily",
    "google_search_console.search_appearance_daily",
...
mod tests {
    ...
    fn minimal_profile_is_site_daily_only() {
        ...
        assert_eq!(streams[0].namespace, "google_search_console.site_daily");
    }
    ...
    fn explicit_streams_filter_overrides_profile() {
        let streams = resolve_streams(
            StreamProfile::Full,
            Some(vec!["google_search_console.query_daily".into()]),
        );
        assert_eq!(streams.len(), 1);
        assert_eq!(streams[0].namespace, "google_search_console.query_daily");
    }
}
