...
class DockerRun extends TestCase
{
    ...
    public function tearDown()
    {
        ...
        array_map('unlink', glob("$path/output/*"));
    ...
    public function setUp()
    {
        ...
        $this->tempPath = Helpers::randomStr(16);

        $basePath = realpath(__DIR__ . '/../../');
        $src = $basePath. '/test-data/0.json.gz';
        $path = $basePath . '/' . $this->tempPath;
...
//        ]));
    ...
    public function assertParquetOutput() {
        ...
        array_map(function ($file) use ($parquetSchema) {
