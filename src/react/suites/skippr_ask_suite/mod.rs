...
impl SkipprAskSuite {
    ...
    fn build_tools(sctx: &SuiteCtx) -> Result<ToolRegistry, String> {
        ...
        use crate::react::suites::skippr_ask_suite::tools::{
    ...
    pub(crate) async fn run_ask(thread_id: &str, question: &str, sctx: &SuiteCtx) -> Result<Vec<FlowFrame>, String> {
        let sys = crate::react::util::time_context::with_time_context(crate::react::suites::skippr_ask_suite::prompts::system_prompt());
        let tools_card = crate::react::suites::skippr_ask_suite::prompts::tool_card();
