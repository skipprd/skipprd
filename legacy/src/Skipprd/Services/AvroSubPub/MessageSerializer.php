...
//    private $registry;
    ...
    public function __construct(CachedSchemaRegistryClient $registry = null, $options = [])
    {
    ...
    public function subjectVersionToWritersSet(string $subject, int $version, AvroSchema $schema)
    {
        ...
        $this->subjectVersionToWriters[$subject][$version] = $avroSchema;
    }
...
//        $name = \AvroUtil::array_value($schema, AvroSchema::NAME_ATTR);
//
//        $foo = $schema->AvroNamedSchema;
